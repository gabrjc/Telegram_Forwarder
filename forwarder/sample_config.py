...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "5705956140:AAH160mdnRdQ_2OTGZ746F7XHAcyftVcZ2Q"  # API key obtained from BotFather
    OWNER_ID = "5333180757"  # If you dont know, run the bot and do /id in your private chat with the bot

    # FOR AUTOMATICALLY FORWARDING MESSAGES
    FROM_CHATS = [-1616988216]  # List of chat id's to forward messages from
    TO_CHATS = [-1722928843]  # List of chat id's to forward messages to
